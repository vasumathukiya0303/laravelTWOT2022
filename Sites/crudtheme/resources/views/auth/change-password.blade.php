    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                ...
                <p class="auth-subtitle mb-5">Input your password and confirm password correctly</p>
                ...
                <form action="{{ route('reset-password') }}" method="post" >
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="email" name="email" class="form-control {{$errors->first('email') ? 'is-invalid' : ''}}" value="{{ old('email') }}" placeholder="Email address">
